			...
			<div className=" card-container mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
				...
				<div className="relative card max-w-md card shadow-lg rounded-lg overflow-hidden">
					...
					<div className="p-4">
						...
						<button className="absolute bottom-2 left-2  btn-link2 font-bold py-2 px-4 mt-4 rounded mt-2">
							بیشتر
						</button>
					</div>
				</div>
				...
				<div className="relative card max-w-md card shadow-lg rounded-lg overflow-hidden">
					...
					<div className="p-4">
						...
						<button className="absolute bottom-2 left-2 btn-link2 font-bold py-2 px-4 rounded mt-2">
							بیشتر
						</button>
					</div>
				</div>
