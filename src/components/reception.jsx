...
const Reception = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center">
            <button className="fixed top-4 right-4 return rounded-md shadow-md" onClick={handleFilterButtonClick}>
                بازگشت به داشبورد
            </button>
            <div className="flex flex-col justify-center items-center relative">
                ...
                <button className="absolute top-20 right-4 -mt-3 -mr-3" id="filter" onClick={handleFilterButtonClick}>
                    <img src="../assets/reception_popup.png" alt="Circle Image" width="38px" height="38px" className="rounded-full item-bg" />
                </button>
            </div>
            {isPopupVisible && (
                <div id="Popup" className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                    <div className="relative p-4 rounded-lg shadow-xl w-72 pop-up flex flex-col items-center justify-center gap-8">
                        ...
                        >
                            <img src="../assets/x.png" alt="Close Icon" />
                        </div>
                        <div className="flex flex-col gap-4 justify-center">
                            <label className="custom-checkbox gap-2" dir="rtl">
                                <input type="checkbox" />
