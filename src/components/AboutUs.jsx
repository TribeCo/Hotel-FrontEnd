				...
				<div className="mx-auto flex items-center px-4" style={{ justifyContent: 'space-between' }}>
					...
					<div className="column-2">
						<a href="https://github.com/Parsavazifeh">
							<img src="https://avatars.githubusercontent.com/Parsavazifeh" alt="Avatar 1" width="40" height="40" style={{ borderRadius: '50%', margin: '0 5px' }} />
						</a>
						<a href="https://github.com/pouryape">
							<img src="https://avatars.githubusercontent.com/pouryape" alt="Avatar 2" width="40" height="40" style={{ borderRadius: '50%', margin: '0 5px' }} />
						</a>
						<a href="https://github.com/TahaM8000">
							<img src="https://avatars.githubusercontent.com/TahaM8000" alt="Avatar 3" width="40" height="40" style={{ borderRadius: '50%', margin: '0 5px' }} />
						</a>
						<a href="https://github.com/pourya22334415">
							<img src="https://avatars.githubusercontent.com/pourya22334415" alt="Avatar 4" width="40" height="40" style={{ borderRadius: '50%', margin: '0 5px' }} />
						</a>
						<a href="https://github.com/Reza-B">
							<img src="https://avatars.githubusercontent.com/Reza-B" alt="Avatar 5" width="40" height="40" style={{ borderRadius: '50%', margin: '0 5px' }} />
						</a>
					</div>
				</div>
				<div style={{ textAlign: 'center', color: 'Highlight', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
					<GroupIcon fontSize="small" style={{ marginLeft: '8px' }} />
